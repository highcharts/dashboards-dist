 ...
 * @internal
 */
export function setRangeOptions(filterOptions, column, minValue, maxValue) {
 ...
 * @internal
 */
export function unsetRangeOptions(filterOptions, column) {
    if (typeof filterOptions.condition !== 'object' ||
        filterOptions.condition.operator !== 'and') {
        return;
    }
 ...
 */
export function toRange(filterOptions) {
    const rangesMap = {};
    if (typeof filterOptions.condition !== 'object' ||
        filterOptions.condition.operator !== 'and') {
        return [];
