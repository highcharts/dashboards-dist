...
export async function addComponent(options, board, cell) {
...
export function getCell(idOrElement, parentElement) {
...
export function getRow(idOrElement, parentElement) {
...
export function getLayout(idOrElement, parentElement) {
