...
export interface Chart {
    new (renderTo: (string | globalThis.HTMLElement), options: Partial<Options>, callback?: Function): Chart;
    axes: Array<Axis>;
    options: Options;
    ...
    xAxis: Array<Axis>;
    yAxis: Array<Axis>;
    addSeries(options: SeriesOptions, redraw?: boolean, animation?: (boolean | Partial<AnimationOptions>)): Series;
    destroy(): void;
...
export interface Series {
    ...
    update(options: Partial<SeriesOptions>, redraw?: boolean): void;
}
...
export declare namespace Highcharts {
    function chart(renderTo: (string | globalThis.HTMLElement), options: Partial<Options>, callback?: Function): Chart;
    function ganttChart(renderTo: (string | globalThis.HTMLElement), options: Partial<Options>, callback?: Function): Chart;
    function mapChart(renderTo: (string | globalThis.HTMLElement), options: Partial<Options>, callback?: Function): Chart;
    function stockChart(renderTo: (string | globalThis.HTMLElement), options: Partial<Options>, callback?: Function): Chart;
}
