...
declare const Formula: {
    ...
    getArgumentValue: (arg: (import("./FormulaTypes.js").Range | import("./FormulaTypes.js").Term), table?: import("../DataTable.js").default) => (import("./FormulaTypes.js").Value | Array<import("./FormulaTypes.js").Value>);
    getArgumentsValues: (args: import("./FormulaTypes.js").Arguments, table?: import("../DataTable.js").default) => Array<(import("./FormulaTypes.js").Value | Array<import("./FormulaTypes.js").Value>)>;
    getRangeValues: (range: import("./FormulaTypes.js").Range, table: import("../DataTable.js").default) => Array<import("./FormulaTypes.js").Value>;
    ...
    processFormula: (formula: import("./FormulaTypes.js").Formula, table?: import("../DataTable.js").default) => import("./FormulaTypes.js").Value;
    ...
    translateReferences: <T extends import("./FormulaTypes.js").Arguments | import("./FormulaTypes.js").Formula>(formula: T, columnDelta?: number, rowDelta?: number) => T;
