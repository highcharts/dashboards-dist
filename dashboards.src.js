/**
 * @license Highcharts Dashboards v4.0.0-rc.1 (2025-10-27)
...
(function (Globals) {
     ...
     *
     * */
    Globals.SVG_NS = 'http://www.w3.org/2000/svg', Globals.product = 'Highcharts', Globals.version = '4.0.0-rc.1', Globals.win = (typeof window !== 'undefined' ?
        window :
 ...
 *
 * */
/* harmony default export */ const Connectors_JSONConnector = (JSONConnector);
...
function JSONConnectorHelper_fromJSON(json) {
    return new Connectors_JSONConnector(json.options);
}
/**
 * Validates the given class instance for JSON support.
 *
...
function JSONConnectorHelper_jsonSupportFor(obj) {
    return obj instanceof Connectors_JSONConnector;
}
/**
 * Converts the given class instance to JSON.
 *
    ...
    updateSeriesFromConnector(connectorHandler) {
        ...
        for (let i = 0, iEnd = columnAssignment.length; i < iEnd; ++i) {
            ...
            if (HighchartsComponent_isString(dataStructure)) {
                ...
                const seriesTable = new Data_DataTable({
...
;// ./code/dashboards/es-modules/Core/Color/Palettes.js
/**
