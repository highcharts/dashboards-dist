/**
 * @license Highcharts Dashboards v2.0.0-rc1 (2024-02-21)
 *
...
(function (root, factory) {
    ...
    _registerModule(_modules, 'Core/Globals.js', [], function () {
        ...
        (function (Globals) {
             ...
             *
             * */
            Globals.SVG_NS = 'http://www.w3.org/2000/svg', Globals.product = 'Highcharts', Globals.version = '2.0.0-rc1', Globals.win = (typeof window !== 'undefined' ?
                window :
    ...
    _registerModule(_modules, 'Dashboards/Components/Component.js', [_modules['Dashboards/CallbackRegistry.js'], _modules['Dashboards/Components/ComponentGroup.js'], _modules['Dashboards/Components/EditableOptions.js'], _modules['Dashboards/Components/Sync/Sync.js'], _modules['Dashboards/Globals.js'], _modules['Core/Utilities.js'], _modules['Dashboards/Components/ComponentUtilities.js'], _modules['Dashboards/Utilities.js']], function (CallbackRegistry, ComponentGroup, EditableOptions, Sync, Globals, U, CU, DU) {
        ...
        const { createElement, isArray, merge, fireEvent, addEvent, objectEach, isFunction, isObject, getStyle, relativeLength, diffObjects } = U;
    ...
    _registerModule(_modules, 'Dashboards/Board.js', [_modules['Dashboards/Actions/Bindings.js'], _modules['Dashboards/Components/ComponentRegistry.js'], _modules['Dashboards/Accessibility/DashboardsAccessibility.js'], _modules['Data/DataCursor.js'], _modules['Dashboards/SerializeHelper/DataCursorHelper.js'], _modules['Data/DataPool.js'], _modules['Dashboards/Globals.js'], _modules['Dashboards/Layout/Layout.js'], _modules['Dashboards/Serializable.js'], _modules['Core/Utilities.js'], _modules['Dashboards/Components/HTMLComponent.js']], function (Bindings, ComponentRegistry, DashboardsAccessibility, DataCursor, DataCursorHelper, DataPool, Globals, Layout, Serializable, U, HTMLComponent) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/DataGridComponent/DataGridSyncHandlers.js', [_modules['Core/Utilities.js']], function (U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/DataGridComponent/DataGridComponentDefaults.js', [_modules['Data/Converters/DataConverter.js'], _modules['Dashboards/Plugins/DataGridComponent/DataGridSyncHandlers.js'], _modules['Core/Utilities.js']], function (DataConverter, DataGridSyncHandlers, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/DataGridComponent/DataGridComponent.js', [_modules['Dashboards/Components/Component.js'], _modules['Dashboards/Plugins/DataGridComponent/DataGridSyncHandlers.js'], _modules['Dashboards/Plugins/DataGridComponent/DataGridComponentDefaults.js'], _modules['Core/Utilities.js']], function (Component, DataGridSyncHandlers, DataGridComponentDefaults, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/DataGridPlugin.js', [_modules['Dashboards/Plugins/DataGridComponent/DataGridComponent.js']], function (DataGridComponent) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/HighchartsComponent/HighchartsSyncHandlers.js', [_modules['Core/Utilities.js']], function (U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/HighchartsComponent/HighchartsComponentDefaults.js', [_modules['Dashboards/Components/Component.js'], _modules['Dashboards/Plugins/HighchartsComponent/HighchartsSyncHandlers.js'], _modules['Core/Utilities.js']], function (Component, HighchartsSyncHandlers, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/HighchartsComponent/HighchartsComponent.js', [_modules['Dashboards/Components/Component.js'], _modules['Data/Converters/DataConverter.js'], _modules['Data/DataTable.js'], _modules['Dashboards/Globals.js'], _modules['Dashboards/Plugins/HighchartsComponent/HighchartsSyncHandlers.js'], _modules['Dashboards/Plugins/HighchartsComponent/HighchartsComponentDefaults.js'], _modules['Core/Utilities.js']], function (Component, DataConverter, DataTable, Globals, HighchartsSyncHandlers, HighchartsComponentDefaults, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/KPIComponent/KPISyncHandlers.js', [_modules['Core/Utilities.js']], function (U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/KPIComponent/KPIComponentDefaults.js', [_modules['Dashboards/Components/Component.js'], _modules['Dashboards/Plugins/KPIComponent/KPISyncHandlers.js']], function (Component, KPISyncHandlers) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/KPIComponent/KPIComponent.js', [_modules['Core/Renderer/HTML/AST.js'], _modules['Dashboards/Components/Component.js'], _modules['Dashboards/Plugins/KPIComponent/KPISyncHandlers.js'], _modules['Dashboards/Plugins/KPIComponent/KPIComponentDefaults.js'], _modules['Core/Templating.js'], _modules['Core/Utilities.js']], function (AST, Component, KPISyncHandlers, KPIComponentDefaults, Templating, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/NavigatorComponent/NavigatorComponentDefaults.js', [_modules['Dashboards/Components/Component.js']], function (Component) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/NavigatorComponent/NavigatorSyncHandlers.js', [_modules['Data/Modifiers/DataModifier.js'], _modules['Core/Utilities.js']], function (DataModifier, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/NavigatorComponent/NavigatorComponent.js', [_modules['Dashboards/Components/Component.js'], _modules['Dashboards/Globals.js'], _modules['Dashboards/Plugins/NavigatorComponent/NavigatorComponentDefaults.js'], _modules['Dashboards/Plugins/NavigatorComponent/NavigatorSyncHandlers.js'], _modules['Core/Utilities.js']], function (Component, Globals, NavigatorComponentDefaults, NavigatorSyncHandler, U) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Dashboards/Plugins/HighchartsPlugin.js', [_modules['Dashboards/Plugins/HighchartsComponent/HighchartsComponent.js'], _modules['Dashboards/Plugins/HighchartsComponent/HighchartsSyncHandlers.js'], _modules['Dashboards/Plugins/KPIComponent/KPIComponent.js'], _modules['Dashboards/Plugins/NavigatorComponent/NavigatorComponent.js']], function (HighchartsComponent, HighchartsSyncHandlers, KPIComponent, NavigatorComponent) {
        /* *
         *
         *  (c) 2009-2024 Highsoft AS
         *
