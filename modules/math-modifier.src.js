...
function negativeReference(formula) {
    ...
    return (formula[formulaLength - 1] === '-' &&
        (0,dashboards_commonjs_dashboards_commonjs2_dashboards_root_Dashboards_.isString)(priorFormula) &&
        !!priorFormula.match(/\*|\/|\^/));
}
/**
...
function applyOperator(values, operators) {
    ...
    if (!(0,dashboards_commonjs_dashboards_commonjs2_dashboards_root_Dashboards_.defined)(secondValue) || !(0,dashboards_commonjs_dashboards_commonjs2_dashboards_root_Dashboards_.defined)(firstValue) || !(0,dashboards_commonjs_dashboards_commonjs2_dashboards_root_Dashboards_.defined)(operator)) {
        values.push(NaN);
    }
    else {
...
;// ./code/dashboards/es-modules/masters/modules/math-modifier.src.js
